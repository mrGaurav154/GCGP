...
import { Clock, Laptop, CheckCircle2, Download, PlayCircle, Star, ArrowRight } from 'lucide-react';
          ...
          <div className="mx-auto max-w-6xl grid lg:grid-cols-5 gap-10 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="lg:col-span-3">
              ...
              <div className="mt-9 flex flex-wrap gap-4">
                ...
                <Link to="/industrial-training/contact" className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-text-primary border border-stone-200 bg-white/70">
            ...
            <div className="flex flex-col gap-16">
              ...
              <Reveal>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {faculty.map((f) => (
                    <div key={f.name} className="rounded-2xl border border-stone-100 p-6 flex items-center gap-4">
              ...
              <Reveal>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  {testimonials.slice(0, 2).map((t) => (
                    <div key={t.name} className="rounded-2xl border border-stone-100 p-6">
