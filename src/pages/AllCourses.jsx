        ...
        <div className="container-px">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 max-w-md relative">
              <Search size={18} className="absolute left-4 top-1/2 -transtone-y-1/2 text-text-secondary" />
              <input
                value={query}
                onChange={(e) => setQuery(e.target.value)}
                placeholder="Search courses..."
                className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-stone-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
              />
            </div>
