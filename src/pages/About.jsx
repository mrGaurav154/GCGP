            ...
            >
              <div className="relative group">
                ...
                <img
                  src={sagarUmalkarImg}
                  alt="Sagar Umalkar"
                  className="relative w-32 h-32 rounded-full object-cover shadow-xl border-4 border-white dark:border-stone-800 transition-transform duration-300 group-hover:scale-105"
                />
              </div>
            </motion.div>
        ...
        <div className="container-px">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 max-w-sm mx-auto">
              <div className="text-center rounded-3xl border border-stone-100 p-8 bg-white dark:bg-bg-dark/40 shadow-sm hover:shadow-md transition-shadow">
                <img
                  src={sagarUmalkarImg}
                  alt="Sagar Umalkar"
        ...
        <div className="container-px">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-12 grid sm:grid-cols-2 gap-6">
              <Reveal direction="left">
                <Link to="/about/career" className="card-hover block h-full rounded-3xl border border-stone-100 bg-white p-8">
              ...
              <Reveal direction="right">
                <Link to="/industrial-training" className="card-hover block h-full rounded-3xl border border-stone-100 bg-white p-8">
                  <span className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-5">
