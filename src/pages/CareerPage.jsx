...
export default function CareerPage() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-teal-50 via-white to-amber-50">
      <div className="absolute -top-40 -left-40 h-96 w-96 rounded-full bg-teal-500/10 blur-3xl"></div>
      ...
      <div className="relative z-10">
        ...
        <section className="section-pad">
          <div className="container-px">
              ...
              {careerHighlights.map((c, i) => {
                ...
                return (
                  <StaggerItem key={c.title}>
                    <div
                      className="accent-card h-full rounded-2xl border border-stone-100 bg-white p-7"
                      style={{ '--accent': accent }}
                    >
            ...
            <div className="mx-auto max-w-3xl mt-14 rounded-2xl border border-stone-100 bg-white/80 backdrop-blur-sm p-8 text-center">
