        ...
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            >
              ...
              <Link to="/industrial-training/courses" className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-text-primary border border-stone-200 hover:border-primary/40 hover:text-primary transition-colors bg-white/70">
                Explore Courses
              </Link>
