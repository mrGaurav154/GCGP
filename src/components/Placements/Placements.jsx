        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-6">
            {placementStats.map((s) => (
              <div key={s.label} className="text-center rounded-2xl border border-stone-100 py-8 px-4">
            ...
            <StaggerGroup className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6" stagger={0.1}>
              {testimonials.map((t) => (
                <StaggerItem key={t.name}>
                  <div className="card-hover rounded-2xl border border-stone-100 p-6 text-center bg-bg">
