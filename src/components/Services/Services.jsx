...
export default function Services() {
  return (
    <section
  id="services"
  className="relative section-pad overflow-hidden bg-gradient-to-br from-teal-50 via-white to-amber-50"
> 
            ...
            {services.map((s, i) => {
              ...
              return (
                <StaggerItem key={s.title}>
                  <div className="card-hover h-full rounded-2xl border border-stone-100 bg-white p-6">
