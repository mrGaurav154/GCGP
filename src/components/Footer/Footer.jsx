...
export default function Footer() {
  return (
    <footer className="bg-bg-dark text-stone-400 pt-20 pb-8">
        ...
        <div className="mx-auto max-w-6xl grid sm:grid-cols-2 lg:grid-cols-5 gap-10 pb-14 border-b border-white/10">
          ...
          <div>
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input type="email" placeholder="Your email" className="flex-1 min-w-0 rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-sm text-white placeholder:text-stone-500 focus:outline-none focus:ring-2 focus:ring-primary/50" />
