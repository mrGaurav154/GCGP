          ...
          <div className="mt-14 grid lg:grid-cols-5 gap-8">
            <Reveal direction="left" className="lg:col-span-2 flex flex-col gap-4">
              {[
                ...
                <div key={item.label} className="flex gap-4 p-5 rounded-2xl border border-stone-100">
              ...
              <div className="rounded-2xl overflow-hidden border border-stone-100 h-56">
                <iframe
            ...
            <Reveal direction="right" className="lg:col-span-3">
              <form onSubmit={handleSubmit(onSubmit)} className="rounded-3xl border border-stone-100 p-6 sm:p-8 grid sm:grid-cols-2 gap-5">
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-text-primary">First Name</label>
                  <input {...register('firstName', { required: true })} className="rounded-xl border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40" placeholder="Your first name" />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input {...register('lastName', { required: true })} className="rounded-xl border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40" placeholder="Your last name" />
                  {errors.lastName && <span className="text-xs text-red-500">Required</span>}
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-sm font-medium text-text-primary">Email</label>
                  <input type="email" {...register('email', { required: true })} className="rounded-xl border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40" placeholder="you@example.com" />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input {...register('phone', { required: true })} className="rounded-xl border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40" placeholder="+91 00000 00000" />
                ...
                <div className="sm:col-span-2 flex flex-col gap-1.5">
                  ...
                  <select {...register('course')} className="rounded-xl border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40">
                ...
                <div className="sm:col-span-2 flex flex-col gap-1.5">
                  ...
                  <textarea {...register('message')} rows={4} className="rounded-xl border border-stone-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40" placeholder="Tell us about your goals" />
                </div>
