...
import { Clock, Laptop, ArrowRight } from 'lucide-react';
import { StaggerItem } from '../shared/Reveal';

export default function CourseCard({ course }) {
  return (
    <StaggerItem>
      <div className="card-hover group h-full flex flex-col rounded-3xl overflow-hidden border border-stone-100 bg-white shadow-sm">
